...
def upload_image_from_path(image_path):
  ...
  try:
    ...
    media_id = seed
    media_url = "http://myphoto/"+image_path
...
def upload_media_news(post_path):
    ...
    for image in images:
        ...
        if image.startswith("http"):
            ...
            media_id, media_url = upload_image_from_path("/Users/nextchen/Dev/project_pig/NDigitalGarden/content/" + image)
        if media_id != None:
...
def run(string_date):
    ...
    print(string_date)
    pathlist = Path("/Users/nextchen/Dev/project_pig/NDigitalGarden/content/notes").glob('**/*.md')
